...
class Solution:
    ...
    def largest_of_three(self, a, b, c): 
        return max(a, b, c)
    ...
    def is_number_palindrome(self, n): 
    ...
    def common_elements(self, lst1, lst2): 
    ...
    def find_missing_number(self, lst): 
        n = len(lst) + 1
    ...
    def to_uppercase(self, lst): 
        return [word.upper() for word in lst]

    def fibonacci_recursive(self, n): 
        return n if n <= 1 else self.fibonacci_recursive(n - 1) + self.fibonacci_recursive(n - 2)
